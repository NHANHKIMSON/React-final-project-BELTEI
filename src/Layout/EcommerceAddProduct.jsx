...
function EcommerceAddProduct(props) {
    return (
        <>
  {/*start main wrapper*/}
                ...
                <div className="row g-3">
                  <div className="col-12 col-lg-3">
                    <div className="nav flex-column nav-pills border rounded vertical-pills overflow-hidden">
                      ...
                      <button
                        className="nav-link active px-4 rounded-0"
                        data-bs-toggle="pill"
                        data-bs-target="#Shipping"
                        type="button"
                      >
                        <i className="bi bi-truck-front-fill me-2" />
                        Shipping
                      </button>
                      <button
                        className="nav-link px-4 rounded-0"
                        data-bs-toggle="pill"
                        data-bs-target="#GlobalDelivery"
                        type="button"
                      >
                      ...
                      <button
                        ...
                        type="button"
                      >
                        <i className="bi bi-hdd-rack-fill me-2" />
                        Attributes
                      </button>
                      <button
                        className="nav-link px-4 rounded-0"
                        ...
                        type="button"
                      >
                        <i className="bi bi-handbag-fill me-2" />
                        Advanced
                      </button>
                    </div>
                  </div>
                    ...
                    <div className="tab-content">
                      ...
                      <div className="tab-pane fade" id="Restock">
                        ...
                        <table className="mt-3">
                          ...
                          <tbody>
                            <tr>
                              <td className="text-1000 py-1">
                                Product in stock now:
                              </td>
                              <td className="text-700 fw-semi-bold py-1">
                                $2,059
                                <button className="btn p-0 ms-2" type="button">
                      ...
                      <div className="tab-pane fade" id="Attributes">
                        ...
                        <div className="form-check">
                          ...
                          />
                          <label
                            className="form-check-label text-900 fs-0"
              ...
              <div className="row g-3">
                ...
                <div className="col-12">
                  <div className="d-flex align-items-center gap-2">
                    ...
                    >
                      Woman <i className="bi bi-x" />
                    </a>
                    <a
                      href="javascript:;"
                      className="btn btn-sm btn-light border shadow-sm"
                    >
                      Fashion <i className="bi bi-x" />
                    </a>
                    <a
                      href="javascript:;"
                      className="btn btn-sm btn-light border shadow-sm"
                    >
                      Furniture <i className="bi bi-x" />
                    </a>
                  </div>
                </div>
                <div className="col-12">

      ...
      <ul className="metismenu" id="sidenav">
          ...
          <ul>
            <li>
              <a href="app-emailbox.html">
                <i className="material-icons-outlined">arrow_right</i>Email Box
              </a>
            </li>
            <li>
              <a href="app-emailread.html">
                <i className="material-icons-outlined">arrow_right</i>Email Read
              </a>
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <a href="ecommerce-customers.html">
                <i className="material-icons-outlined">arrow_right</i>Customers
              </a>
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <a href="component-accordions.html">
                <i className="material-icons-outlined">arrow_right</i>Accordions
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="component-carousels.html">
                <i className="material-icons-outlined">arrow_right</i>Carousels
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="component-paginations.html">
                <i className="material-icons-outlined">arrow_right</i>Pagination
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="component-typography.html">
                <i className="material-icons-outlined">arrow_right</i>Typography
              </a>
            </li>
            <li>
              <a href="component-text-utilities.html">
                <i className="material-icons-outlined">arrow_right</i>Utilities
              </a>
            </li>
          </ul>
        </li>
          ...
          <ul>
            <li>
              <a href="icons-line-icons.html">
                <i className="material-icons-outlined">arrow_right</i>Line Icons
              </a>
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <a href="table-datatable.html">
                <i className="material-icons-outlined">arrow_right</i>Data Table
              </a>
            </li>
          </ul>
        </li>
              ...
              <ul>
                <li>
                  <a href="auth-basic-login.html" target="_blank">
                    <i className="material-icons-outlined">arrow_right</i>Login
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="auth-basic-forgot-password.html" target="_blank">
                    <i className="material-icons-outlined">arrow_right</i>Forgot
                    Password
                  </a>
                </li>
                <li>
                  <a href="auth-basic-reset-password.html" target="_blank">
                    <i className="material-icons-outlined">arrow_right</i>Reset
                    Password
                  </a>
                </li>
              </ul>
          ...
          <ul>
            <li>
              <a href="pages-error-404.html" target="_blank">
                <i className="material-icons-outlined">arrow_right</i>404 Error
              </a>
            </li>
            <li>
              <a href="pages-error-505.html" target="_blank">
                <i className="material-icons-outlined">arrow_right</i>505 Error
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="pages-starter-page.html" target="_blank">
                <i className="material-icons-outlined">arrow_right</i>Blank Page
              </a>
            </li>
          </ul>
        </li>
        ...
        <li>
          ...
          <ul>
            <li>
              <a className="has-arrow" href="javascript:;">
                <i className="material-icons-outlined">arrow_right</i>Level One
              </a>
              <ul>
                <li>
                  <a className="has-arrow" href="javascript:;">
